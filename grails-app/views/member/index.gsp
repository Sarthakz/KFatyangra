		...
		<div id="list-member" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="member.role.label" default="Role" /></th>
				...
				<g:each in="${memberInstanceList}" status="i" var="memberInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${memberInstance.id}">${fieldValue(bean: memberInstance, field: "fullName")}</g:link></td>
					
						<td>${fieldValue(bean: memberInstance, field: "password")}</td>
					
						<td>${fieldValue(bean: memberInstance, field: "role")}</td>
